...
function [TxBFLocal, PowerLocal] = TxBFStaticAllocation(LinkID, InitRxBFs, InitTxBFs, InitPower, SystemSettings)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description:
% Return a static beamformer for link "LinkID", as the input InitTxBfs
%
% Input: 
