...
%
function RxBF = RxBFMMSEAllocation(LinkID, InitTxBFs, InitPower, SystemSettings)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Input: 
...
for jj=1:Nlink
    ...
    T_ii = T_ii + Power_jj*H_ji*(TxBF_jj*TxBF_jj')*H_ji';
end
% Rx-beamforming with MMSE
% RxBF = sqrt(InitPower(LinkID))*inv(T_ii')*H_ii* TxBF_ii;
RxBF = sqrt(InitPower(LinkID))*inv(T_ii)*H_ii* TxBF_ii;
end